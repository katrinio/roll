...
В CLI `features` вводятся по одному значению за раз. Разделители не используются, допустим `_` внутри значения.
...
В CLI теги тоже вводятся по одному значению за раз. Разделители не используются, допустим `_` внутри значения.
